...
class ControlsControllerTest < ActionController::TestCase
  ...
  test "should create control" do
    assert_difference('Control.count') do
      post :create, control: { email: @control.email, first: @control.first, last: @control.last, score: @control.score }
    end
  ...
  test "should update control" do
    patch :update, id: @control, control: { email: @control.email, first: @control.first, last: @control.last, score: @control.score }
    assert_redirected_to control_path(assigns(:control))
  end
