...
class HighScoresControllerTest < ActionController::TestCase
  ...
  test "should create high_score" do
    assert_difference('HighScore.count') do
      post :create, high_score: { email: @high_score.email, first: @high_score.first, last: @high_score.last, score: @high_score.score }
    end
  ...
  test "should update high_score" do
    patch :update, id: @high_score, high_score: { email: @high_score.email, first: @high_score.first, last: @high_score.last, score: @high_score.score }
    assert_redirected_to high_score_path(assigns(:high_score))
  end
